 ...
 */
char font[] = "Droid Sans Mono Slashed for Powerline:pixelsize=14:antialias=true:autohint=true";
int borderpx = 2;
...
Shortcut shortcuts[] = {
	...
	{ ShiftMask, 	        XK_Insert,           clipcopy,       {.i =  0} },
	{ ShiftMask,              XK_Print,           clippaste,      {.i =  0} },
